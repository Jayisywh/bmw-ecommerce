        ...
        <div className="flex flex-wrap gap-4 mt-4">
          {options.colors.map((c) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 rounded-full border border-black/10 dark:border-white/20 flex items-center justify-center text-xs font-black text-gray-900 dark:text-gray-100">
                  {c.color.slice(0, 2)}
                </div>
              </button>
            );
            ...
            <button
              ...
              className={`flex justify-between p-4 rounded-xl border-2 transition-all ${
                config.wheels?.size === s.size
                  ? "border-[#1C69D2] bg-blue-50 dark:bg-blue-900/20 dark:border-[#1C69D2]"
                  : "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-[#111827]"
              }`}
            >
              <div>
              ...
              <p className="font-black text-[#1C69D2] dark:text-blue-400">
          ...
          {options.package.map((pkg) => {
            ...
            return (
              <div
                ...
                className={`flex justify-between p-5 rounded-2xl border-2 cursor-pointer transition-all ${
                  selected
                    ? "border-[#1C69D2] bg-blue-50 dark:bg-blue-900/20 dark:border-[#1C69D2]"
                    : "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-[#111827]"
                }`}
                ...
                <div className="flex gap-3 items-center">
                  <div
                    className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all ${
                      selected
                        ? "bg-[#1C69D2] border-[#1C69D2] dark:bg-blue-500 dark:border-blue-500"
  ...
  return (
    <div className="flex justify-between border-b border-gray-200 dark:border-gray-700 pb-2">
      <div className="flex gap-3">
        <span className="text-xs text-[#1C69D2] dark:text-blue-400">
          {number}
        </span>
